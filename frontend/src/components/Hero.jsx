...
const Hero = ()=>{
    ...
    <div className="flex w-full max-w-7xl mx-auto items-center justify-between gap-24 mt-20 px-12">
        <div className="flex flex-col items-start gap-4">
           ...
           I enjoy turning ideas into functional and user-friendly web applications. With a strong foundation in the MERN stack, C++, Object-Oriented Programming, and Database Management Systems, I'm constantly learning, building projects, and sharpening my problem-solving skills.
            </p>
            ...
            <div className="flex items-center ml-3 gap-10 mt-3">
                ...
                <a href='https://mail.google.com/mail/?view=cm&fs=1&to=98vansh98@gmail.com'>
